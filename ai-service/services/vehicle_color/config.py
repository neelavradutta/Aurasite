...
class ColorDetectionConfig:
    ...
    min_confidence_snapshot: float = 0.22
    ...
    snapshot_body_inset_x: float = 0.04
    snapshot_body_inset_top: float = 0.08
    snapshot_body_inset_bottom: float = 0.14
    ...
    max_pixels: int = 5000
    min_paint_pixels: int = 16
    cluster_weight_threshold: float = 0.14
